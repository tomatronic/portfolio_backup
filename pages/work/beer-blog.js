    ...
    return (
        <>
            <div className="bg-slate-100">                
                ...
                <div className="text-2xl md:text-5xl leading-7 tracking-tight">It's Brewtiful</div>
                ...
                <div className="container max-w-screen-lg mx-auto mb-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-gray-500 to-transparent opacity-50 dark:opacity-100"></div>
