    ...
    return (
        <>
            <div className="bg-slate-100">                
                <div className="container max-w-screen-full h-[70vh] mx-auto px-6 bg-[url('/backgroundBrew.png')]">
                    <div className="flex flex-row flex-wrap content-center max-w-screen-md mx-auto">
