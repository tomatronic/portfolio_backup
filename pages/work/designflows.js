                ...
                <div className="container max-w-screen-lg mx-auto px-6 pt-20">
                    <div className="grid grid-cols-4 gap-10 auto-rows-auto">
                        ...
                        <div className="col-span-3 pb-10">
                            ...
                            <h2 className="pt-5">Competitor research</h2>
                            ...
                            <h2 className="pt-5">Initial ideas</h2>
                            ...
                            <h2 className="pt-5">Icon Decision</h2>
                            ...
                            <h2 className="pt-5">Final thoughts</h2>
