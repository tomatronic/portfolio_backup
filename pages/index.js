        ...
        <div className="pt-40 md:pt-20">
          <Layout>
            <div className="relative" style={{ height: '100vh' }}>
              ...
              <div className="container max-w-screen-md mx-auto px-6 flex flex-col justify-center text-center z-10 md:text-left flex-wrap max-w-s md:max-w-3xl my-16 md:mb-36 md:mt-40">                <div className="text-2xl md:text-5xl md:leading-snug tracking-tight">
